...
label = joblib.load("./labelarray.pkl")
feature = joblib.load("./featurearray.pkl")
means = joblib.load("./mean.pkl")
stds = joblib.load("./std.pkl")
features = feature
labels = label
mean = means
std = stds
...
joblib.dump(result_dict, "./result_dict.pkl")
pickle.dump(rf, open("./model.dat", "wb"))

result_dict = joblib.load("./result_dict.pkl")
